...
namespace RomanticWeb.DotNetRDF
{
    ...
    {
        private static string DeleteEntityGraphCommandText=Resource.AsString("Queries.DeleteEntityGraph.ru");
        private static string DeleteDataCommandText=Resource.AsString("Queries.DeleteData.ru");
        private static string InsertEntityCommandText=Resource.AsString("Queries.InsertEntity.ru");
        private static string InsertBlankNodeCommandText=Resource.AsString("Queries.InsertBlankNode.ru");
        ...
        private IGraph _nodeFactory=null;
