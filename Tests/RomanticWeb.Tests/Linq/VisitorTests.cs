...
namespace RomanticWeb.Tests.Linq
{
    ...
    public class VisitorTests
    {
        ...
        public void Setup()
        {
            ...
            _tracker.Setup(store => store.AssertEntity(It.IsAny<EntityId>(), It.IsAny<IEnumerable<EntityQuad>>()));
            ...
            _persons = new EntityQueryable<IPerson>(_entityContext.Object, _entitySource.Object, _tracker.Object);
