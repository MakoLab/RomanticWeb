...
namespace RomanticWeb.Linq.Model.Navigators
{
    ...
    internal class IdentifierEntityAccessorNavigator:QueryComponentNavigatorBase
    {
        #region Constructors
        ...
        internal IdentifierEntityAccessorNavigator(IdentifierEntityAccessor entityAccessor):base(entityAccessor)
        {
        }
        #endregion
        ...
        public IdentifierEntityAccessor NavigatedComponent { get { return (IdentifierEntityAccessor)((IQueryComponentNavigator)this).NavigatedComponent; } }
        #endregion
