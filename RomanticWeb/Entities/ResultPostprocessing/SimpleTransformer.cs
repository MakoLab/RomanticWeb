...
{
    /// <summary>
    /// Basic <see cref="IResultTransformer"/> which only converts nodes using <see cref="INodeConverter"/>
    /// and aggregates the result a <see cref="IResultAggregator"/>
    /// </summary>
    ...
    public class SimpleTransformer:IResultTransformer
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleTransformer"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Converts <paramref name="nodes"/> and returns the aggregated the result.
        /// </summary>
        ...
        /// <summary>
        /// Converts the given <paramref name="value"/> to <see cref="Node"/>s.
        /// </summary>
