...
namespace RomanticWeb.Linq
{
    ...
    public class EntityQueryable<T>:QueryableBase<T>
    {
        ...
        /// <param name="mappings">Repository of mappings to be used when resolving strong types to ontologies.</param>
        /// <param name="ontologyProvider">Ontology provider to be used when resovling classes and predicates.</param>
        protected internal EntityQueryable(IEntityContext entityContext,IMappingsRepository mappings,IOntologyProvider ontologyProvider):
            base(QueryParser.CreateDefault(),new EntityQueryExecutor(entityContext,mappings,ontologyProvider))
        {
